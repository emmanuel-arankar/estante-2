...
import { pageVariants, SMOOTH_TRANSITION } from '../lib/animations'; // # atualizado
...
export const Profile = () => {
  // # atualizado: A lógica de renderização do componente foi reestruturada para corrigir a sobreposição e a falta de conteúdo nas abas.
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                {convertFirestoreDate(profileUser.birthDate) && (
                  <div className="flex items-center">
                    ...
                    <span>
                      Nasceu em {format(convertFirestoreDate(profileUser.birthDate)!, "dd 'de' MMMM", { locale: ptBR })}
                    </span>
                  </div>
                )}
                <div className="flex items-center">
