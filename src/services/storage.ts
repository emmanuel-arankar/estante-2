...
// ✅ FUNÇÃO PARA VERIFICAR METADATA DE UMA IMAGEM
export const getImageMetadata = async (imageUrl: string): Promise<void> => {
  try {
    // Nota: Firebase Storage não tem API direta para pegar metadata via URL
    // Esta é uma limitação - você precisaria da referência original
