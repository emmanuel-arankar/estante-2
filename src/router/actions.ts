...
import { doc, setDoc, updateDoc, getDoc } from 'firebase/firestore'; // # atualizado
...
// # atualizado: Nova query para o perfil do usuário
...
export const loginAction = async ({ request }: any) => {
  ...
  try {
    ...
    // # atualizado: Pré-aquecer o cache com os dados do perfil após o login
...
export const editProfileAction = async ({ request }: any) => {
    ...
    try {
        ...
        // Invalida o cache do usuário para forçar o loader a buscar dados frescos na próxima vez
